...
if (alltests || test == 17)
        // Test removing a node with two children and checking smallest and largest
        try {
            dictionary = new BSTDictionary();
            dictionary.put(new Record(new Key("5",TEXT),"five"));
            dictionary.put(new Record(new Key("7",TEXT),"seven"));
            dictionary.put(new Record(new Key("6",TEXT),"six"));
            dictionary.put(new Record(new Key("8",TEXT),"eight"));
            
            dictionary.remove(new Key("7",TEXT));
            
            rec = dictionary.smallest();
            if ((rec.getKey().getLabel()).compareTo("5") == 0)
                System.out.println("Test 17 smallest passed");
            else System.out.println("Test 17 smallest failed");
            
            rec = dictionary.largest();
            if ((rec.getKey().getLabel()).compareTo("8") == 0)
                System.out.println("Test 17 largest passed");
            else System.out.println("Test 17 largest failed");

			dictionary.remove(new Key("6",TEXT));
